# Just in case - vagrant with rocky8 linux box

Do people still use vagrant?  If you do and your distro of choice is Rocky Linux, you might find yourself stuck in version 5.0.0 box for some reason.  Here is how you can use a newer box.  
```
# -*- mode: ruby -*-
# vi: set ft=ruby :
